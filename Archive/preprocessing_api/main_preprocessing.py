...
# local-modules
from app.preprocessing.aws_functions import aws_list_folders
...
from app.preprocessing.logging_config import get_logger
from app.preprocessing.save_to_disk import preprocess_and_save_data
from app.preprocessing.settings import DOCKERIZED, MAKE_TRAININGS_DATA, PRODUCTION
...
def main_preprocessing() -> None:
    ...
    # req.request.headers
    # req.request.body
    logger.info(f"Preprocessing started {IMAGE_INPUT_DIR}")
