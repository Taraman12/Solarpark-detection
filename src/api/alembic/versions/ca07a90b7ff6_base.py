...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_solarparkobservation_id"), "solarparkobservation", ["id"], unique=False
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_solarparkobservation_id"), table_name="solarparkobservation")
    op.drop_geospatial_index(
        "idx_solarparkobservation_geom",
        table_name="solarparkobservation",
        postgresql_using="gist",
        column_name="geom",
    )
